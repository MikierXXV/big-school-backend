...
import type { SendVerificationEmailOptions } from '../../application/ports/email.service.port.js';

/**
 * Genera el HTML del email de verificación de cuenta.
 */
export function buildVerificationEmailHtml(options: SendVerificationEmailOptions, appName: string): string {
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="margin:0 0 16px;color:#374151;font-size:16px;line-height:1.6;">
                Gracias por registrarte en ${appName}. Para activar tu cuenta y acceder a todas las funcionalidades, necesitas verificar tu dirección de email.
              </p>
              ...
              <p style="margin:0 0 32px;word-break:break-all;">
                <a href="${verificationLink}" style="color:#2563eb;font-size:14px;">${verificationLink}</a>
              </p>
              <hr style="border:none;border-top:1px solid #e5e7eb;margin:0 0 24px;" />
              <p style="margin:0;color:#9ca3af;font-size:13px;line-height:1.5;">
                Este enlace es válido durante <strong>5 horas</strong>. Si no creaste esta cuenta, puedes ignorar este mensaje.
              </p>
            </td>
          </tr>
          <!-- Footer -->
